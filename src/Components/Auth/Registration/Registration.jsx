...
const Reg = (props) => {
    ...
    return <div className={S.formReg}>
        ...
        <div>
            <Button  disabled={!formValid}>Registration</Button>
        </div>
        <div className={S.Or} >or</div>
        <NavLink to='/registration'><Button style={{ backgroundColor: 'lightgray', color: 'black' }} variant="contained">Login now</Button></NavLink>
    </div>
}
